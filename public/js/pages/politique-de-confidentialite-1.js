  ...
  /* ----------------------------------------------------
     ...
     une page toute fermee ; sa premiere fermeture part bien
     de sa hauteur reelle.
     ---------------------------------------------------- */
  (function setupAccordions() {
    ...
    Array.prototype.forEach.call(questions, function (q) {
      ...
      // Etat initial : un item ouvert au chargement passe a height:auto.
      ...
      q.addEventListener('click', function () {
        ...
        if (isOpen) {
          // Fermeture : fige la hauteur courante puis anime vers 0.
